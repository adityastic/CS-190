...
class MyFrameALL extends JFrame implements ActionListener{
	/**
	 * 
	 */
	...
	private JButton b10=new JButton("Total Age:");private JTextField t101=new JTextField("",8);JTextField t102=new JTextField("",8);
	MyArrayList l=new MyArrayList(12);

	public void display(){
		t1.setText(l.printlist());
	}

	public MyFrameALL(String s){
		super(s);
	...
	public void actionPerformed(ActionEvent e){
		...
		if (target==b10){
			t101.setText(""+l.totalAge());
			t102.setText(""+l.countEvenAge());
		}
	}
